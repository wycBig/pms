...
<form name="form2">
    ...
    <table id="_table_list" width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
        ...
        <c:forEach items="${mv}" var="mods" varStatus="index">
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
                <td><input name="id" type="checkbox" id="id" value="${mods.id}" class="np"></td>
                <td>${index.count}</td>
                <td align="center">
                    <a href=''><u>${mods.modname}</u>
                    </a></td>
                <td align="center">
                    <a href=''><u>${mods.analysisFk}</u>
                    </a></td>
                <td align="center">
                    <a href=''><u>${mods.proname}</u>
                    </a></td>
                <td>${mods.level}</td>
                <td>2015-02-03</td>
                <td>2015-06-03</td>
