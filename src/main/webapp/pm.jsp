...
<title>用户管理</title>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/js/css/font-awesome.min.css">
...
<script type="text/javascript">
       ...
       function editNode(id) {
       	   window.location.href = "${pageContext.request.contextPath}/source/getById/"+id;
       }
