...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript" >
		$(function () {
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/pos/getPos",
				success:function (msg) {
					$(msg).each(function (index,item) {
						var option = "<option value='"+item.id+"'>"+item.name+"</option>";
					    $("#_position").append(option);
                    })
                }
			});
            $.ajax({
                ...
                success:function (msg) {
                    $(msg).each(function (index,item) {
                        var checked = "<input name='roleid' value='"+item.roleid+"' type='checkbox'/> "+item.rolename;
                        $("#role_").append(checked);
                    })
                }
            })
        })
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/emp/insert" method="post">
<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
	...
	<tr >
		...
		<td id="role_" align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		</td>
	</tr>
