...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/attach/addAttach" method="post" enctype="multipart/form-data">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="getProName" name="proFk" >
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="multipartFile" type="file"/></td>
</tr>
