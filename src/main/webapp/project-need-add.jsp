...
<link rel="stylesheet" type="text/css" href="skin/css/base.css">
	...
	<script type="text/javascript">
        $(function () {
            ...
            $.ajax({
                type:"get",
                url:"${pageContext.request.contextPath}/pro/getAllPro",
                success:function (pro) {
                    $(pro).each(function (index,item) {
                        var option = "<option value='"+item.pname+"' >"+item.pname+"</option><>";
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/anal/insertAnal" method="post">
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		...
		<tr >
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<select id="selectPro" name="proname" >
					<option>-------请选择-------</option>
				</select>
			</td>
		</tr>
