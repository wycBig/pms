        ...
        function getNeed(pid) {
            $.ajax({
                ...
                success:function (anal) {
                    var option = "<option  value='"+anal.id+"' >"+anal.title+"</option>"
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/func/addFunction" method="post" >
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		...
		<tr >
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<select name="proname" id="selectPro" onchange="getNeed(this.value)" >
					<option>-------请选择-------</option>
				</select>
			</td>
		</tr>
		<tr >
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<select  name="analysisname" id="geNeedd" onchange="parseModel(this.value)" >
					<option>需求管理模块</option>
				</select>
			</td>
		</tr>
		<tr >
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<select  name="modele_fk" id="getModel" >
					<option>帐户管理模块</option>
				</select>
			</td>
		</tr>
		<tr >
		...
		<td height="28" colspan=4 align=center>
			&nbsp;
			<a href="javascript:submits()" class="coolbg">保存</a>
