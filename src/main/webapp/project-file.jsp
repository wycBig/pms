...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/attach/getCond' method='get'>
...
<form name="form2">
    <table width="98%" border="1" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
        ...
        <c:forEach items="${attach}" var="att" varStatus="index">
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
                ...
                <td align="center">
                    <a href=''>
                        <u>${att.project.pname}</u>
                    </a></td>
                <td>${att.remark}</td>
                <td>
                    <fmt:formatDate value="${att.project.starttime}" pattern="yyyy-MM-dd"></fmt:formatDate>
                </td>
                <td>
                    <fmt:formatDate value="${att.project.endtime}" pattern="yyyy-MM-dd"></fmt:formatDate>
                </td>
                <td>
                    <a href="${pageContext.request.contextPath}/attach/upLoad/${att.id}">下载</a> |
                    <a href="${pageContext.request.contextPath}">删除</a> |
                    <a href="${pageContext.request.contextPath}">编辑</a> |
                    <a href="${pageContext.request.contextPath}">查看详情</a></td>
            </tr>
        </c:forEach>
        <tr bgcolor="#FAFAF1">
