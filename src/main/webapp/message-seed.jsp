...
<script type="text/javascript">
   $(function () {
	   $.ajax({
		   type:"get",
		   url:"${pageContext.request.contextPath}/arch/getEmail",
		   success:function (msg) {
               $(msg).each(function (indexm,item) {
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/email/saveInfo" method="post" >
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		...
		<tr >
			...
			<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<input type="text" name="sendtime" /></td>
		</tr>
		<tr >
