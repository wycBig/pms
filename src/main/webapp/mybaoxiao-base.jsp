...
<!--  搜索表单  -->
<form id ="form3" name='form3' action='${pageContext.request.contextPath}/bx/list' method='get'>
...
<form name="form2">
	...
	<table width="98%"  cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
		...
		<tr align="center" bgcolor="#FAFAF1" height="22">
			...
			<c:forEach items="${mv.list}" var="bs" varStatus="index">
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
					...
					<td align="center">
						<a href=''><u>
							<fmt:formatDate value="${bs.bxtime}" pattern="yyyy-MM-dd"></fmt:formatDate> </u>
						</a>
					</td>
					<td>${bs.bxremark}</td>
		...
		<tr align="right" bgcolor="#EEF4EA">
			<td height="36" colspan="12" align="center">
				<jsp:include page="navigatepageNum.jsp"></jsp:include>
			</td>
		</tr>
	</table>
...
<script type="text/javascript">
    function queryList() {
        ...
        var reg=/^[0-9]+$/;
        if(!reg.test(pageNum)){
            alert("组织机构代码必须是9位字母或数字！");
            return;
        }else{
            window.location.href="${pageContext.request.contextPath}/bx/list?pageNum="+pageNum;
		}
    }
</script>
</html>